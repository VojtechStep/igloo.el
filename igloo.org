...
(igloo-use-package consult
  ...
  (consult-project-function #'igloo--consult-project-root)
  ...
  (defun igloo--consult-project-root (_may-prompt)
...
(igloo-use-package org
  ...
  (igloo-leader
    ...
    "oci" '(igloo-clock-in :wk "clock in" :no-autoload t)
    "oco" '(igloo-clock-out :wk "clock out" :no-autoload t)
...
(igloo-use-package org-agenda
  ...
  (org-agenda-clockreport-parameter-plist '(:maxlevel 3 :indent nil :fileskip0 t))
